...
<body>
	...
	<div>
		<img src="../ressources/img/admin/list.png" class="list">
		<h1 class=free>질의응답게시판</h1>
	</div>

	<form action="questioninsertupdate2" method="POST">
		...
		<div class="button">
			<button type="button" id="questioninsertwritebtn" name="writebtn">저장</button>
	...
	<jsp:include page="/WEB-INF/views/footer.jsp" />
		...
		<script type="text/javascript">
			window.onload = function() {
				//버튼을 누를때 실행
				var btn = document.getElementById("questioninsertwritebtn");
