...
<!-- 	<div class="radio">
		...
		<c:if test="${listCount ne 0 }">
			<c:forEach var="vo" items="${list}" varStatus="status">
				<tr>
					...
					<td align="left"><a href="eventdetail?boardNo=${vo.boardNo }&page=${currentPage}" class="title">${vo.boardTitle }</a>
					&nbsp;
	...
	<script>
		$(".write-button").on("click", function() {
			...
			var frm = document.getElementById("eventwriteBtn2");
			frm.action = "eventwrite";
			frm.method = "get";
			frm.submit();
		});
