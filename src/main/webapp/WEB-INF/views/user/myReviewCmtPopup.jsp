...
<body>
	...
	<c:if test="${!empty rBoardCmtMore }">
			...
			<table>
					<thead>
						<tr class="row100 head">
							<th class="cell100 column1" style="background-color: #add9d4 !important;">댓글 번호</th>
							<th class="cell100 column2" style="background-color: #add9d4 !important;">댓글 제목</th>
		...
		<div class="table100-body js-pscroll ps ps--active-y">		
			<table>
				<tbody>
					<c:forEach var="r" items="${rBoardCmtMore }" varStatus="status">
						<tr class="row100 body">
							<td class="cell100 column1">${r.boardNo }</td>
							<td class="cell100 column2">${r.boardTitle}</td>
							<td class="cell100 column3">${r.boardDate}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
